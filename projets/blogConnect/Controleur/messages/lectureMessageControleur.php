    ...
    <div class="navbar-wrapper  ">
        <div class="navbar-content scroll-div " >
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="../publications/publication.php" class="nav-link ">
							<span class="pcoded-micon">
                ...
                <li class="nav-item">
                    <a href="../publications/actu.php" class="nav-link ">
							<span class="pcoded-micon">
								<i class="feather icon-box"></i>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-12">
                                        <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            <li><a class="nav-link text-left active" id="v-pills-home-tab" data-toggle="pill" href="messages.php" role="tab" aria-controls="v-pills-home" aria-selected="true">Boite de reception</a></li>
                                    ...
                                    <div class="col-md-9 col-sm-12">
                                        <div class="tab-content" id="v-pills-tabContent">
                                                        ...
                                                        if(isset($_GET['id']) AND !empty($_GET['id'])) {
                                                            ...
                                                            <div>
                                                                <?php if($msg_nbr == 0) { echo "Erreur"; } else { ?>
                                                                    ...
                                                                    <b>Objet:</b> <?= $m['objet'] ?>
                                                                    <br /><br />
                                                                    Contenu du message : <?= nl2br($m['message']) ?><br />
                                                                <?php } ?>
                                                            </div>
                                                            <a href="envoi.php?r=<?= $p_exp ?>&o=<?= urlencode($m['objet']) ?>">Répondre</a>
                                                            <a href="../publications/supprimer.php?id=<?= $m['id_message'] ?>">Supprimer</a><br /><br /><br />
                                                            </body>
                                                            </html>
                                                            <?php
                                            ...
                                            <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                                <form class="needs-validation" novalidate action="envoiMessage.php" method="post">
                                                    <div class="form-row">
